...
<table class="create-post">
	...
	<td colspan=4>
	    <h3>Title:</h3>
	    <?php echo form_input('title', set_value('title', ''), 'class="post-title"'); ?>
	</td>
    </tr>
    <tr>
	<td>
	    <h3>Class</h3>
	    <?php echo form_dropdown('class', $this->config->item('cars_class')); ?>
	</td>
	<td>
	    <h3>Изображение:</h3>
...
<h3>Text:</h3>
<?php echo form_textarea('description', set_value('description', ''), 'class="post-body"'); ?><br />
